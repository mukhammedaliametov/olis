  ...
  return (
    <div className="max-w-[1450px] mx-auto py-[20px] px-[12px] lg:px-[30px] 2xl:px-[0px]">
      <div className="flex flex-col-reverse md:flex-row items-center w-full justify-between mt-[30px]">
        <div className="w-full lg:w-[300px] flex justify-between items-center gap-[10px]">
          ...
          <div className="w-full sm:w-[150px] lg:w-[490px] z-2 mt-[20px] md:mt-0">
            <h1 className="text-[28px]/[26px] lg:text-[42px]/[40px] w-full text-[#FEAD04] font-black">ТЕХНОЛОГИИ <p className="bg-[#F8F8F8] py-[15px] w-full sm:w-[440px]">И ОБОРУДОВАНИЕ</p></h1>
            <p className="w-full md:w-[310px] font-light text-[22px] md:text-[26px] border-t border-black pt-[10px] mt-[10px]">для очистки, переработки и контроля качества зерна</p>
